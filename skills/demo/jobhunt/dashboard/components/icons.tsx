...
export function Icon({ name, size = 14, color = 'currentColor', style }: IconProps) {
  ...
  switch (name) {
    ...
    case 'dot':
      return <svg {...common} fill={color}><circle cx="12" cy="12" r="4" stroke="none"/></svg>;
    case 'square':
    ...
    case 'compass':
      return (
        <svg {...common}>
          ...
          <path d="M16 8l-2 6-6 2 2-6z" fill={color} stroke="none" opacity="0.6"/>
        </svg>
      );
    case 'target':
      return (
    ...
    case 'users':
      return (
        <svg {...common}>
          ...
          <path d="M15 20v-1a4 4 0 0 1 4-4h.5"/>
        </svg>
      );
    case 'message':
      return <svg {...common}><path d="M21 12a8 8 0 1 1-3.5-6.6L21 4l-1 4.5A8 8 0 0 1 21 12z"/></svg>;
    case 'doc':
      return (
        <svg {...common}>
    ...
    case 'book':
      return (
        <svg {...common}>
          <path d="M4 4v15a2 2 0 0 1 2-2h14V3H6a2 2 0 0 0-2 2z"/>
    ...
    case 'graph':
      return (
        <svg {...common}>
          ...
          <path d="M7.5 17l3-9M13.5 7.5l3 5.5"/>
        </svg>
      );
    case 'plus':
    ...
    case 'pin':
      return <svg {...common}><path d="M12 21s-7-7-7-12a7 7 0 0 1 14 0c0 5-7 12-7 12z"/><circle cx="12" cy="9" r="2.5"/></svg>;
    case 'flag':
...
export interface SchemaTagProps {
  type: string;
  id?: string;
  onOpen?: () => void;
}

export function SchemaTag({ type, id, onOpen }: SchemaTagProps) {
  return (
    <button
      onClick={onOpen}
      ...
      style={{
        ...
        border: `1px dashed ${TOKENS.borderDim}`,
        borderRadius: 3,
        padding: '1px 5px',
        cursor: 'pointer',
        display: 'inline-flex',
      ...
      onMouseLeave={(e) => {
        e.currentTarget.style.color = TOKENS.fgFaint;
        e.currentTarget.style.borderColor = TOKENS.borderDim;
      }}
    >
