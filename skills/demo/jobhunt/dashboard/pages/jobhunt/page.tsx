...
export default function MissionControl() {
  ...
  const fetchItems = useCallback(async (exclude?: Set<string>) => {
    setLoading(true);
    try {
      // Read pre-computed embedding map (generated by: uv run python embedding_map.py embed-and-map)
      const res = await fetch('/embedding-map.json');
      if (!res.ok) throw new Error('Failed to load embedding map. Run: uv run python embedding_map.py embed-and-map');
